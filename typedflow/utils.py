...
def dump_to_each_file(batch: Batch[T],
    ...
    path_method
        A function which transforms batch_id into a file path where the batch is saved.
    """
...
def dump_to_one_file(batch: Batch[T],
                     path: Path) -> None:
    """
    Dump the batch in a file. Unlike `dump_to_each_file`, this dumps all the batch
